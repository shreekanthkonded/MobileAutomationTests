...
public class Senario6 
{
	...
	@Test(priority=2)
	public static void VerifyElementsInSettings() throws InterruptedException
	{
		driver.findElementById("com.july.cricinfo:id/menu_settings").click();
		waitTime(2000);
		if(driver.getPageSource().contains("Favourites and Alerts"))
		{
