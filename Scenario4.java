...
public class Scenario4 {
	...
	@Test(priority=1)
	public static void SelectFavTeams() throws InterruptedException
	{
		...
		waitTime(2000);
		driver.findElementByXPath("//android.widget.TextView[@text='Delhi Daredevils']").click();
		waitTime(2000);
		driver.findElementByXPath("//android.widget.TextView[@text='Kings XI Punjab']").click();
		waitTime(2000);
		driver.findElementByXPath("//android.widget.TextView[@text='Royal Challengers Bangalore']").click();
		waitTime(2000);
		driver.findElementById("com.july.cricinfo:id/nextText").click();
		waitTime(5000);
	}
	...
	@Test(priority=2)
	public static void VerifyFavTeams() throws InterruptedException 
	{
		driver.findElementByXPath("//*[@text='Series']").click();
		waitTime(5000);
		driver.findElementById("com.july.cricinfo:id/xEditButton").click();
		waitTime(3000);
		if(driver.getPageSource().contains("KXIP") && driver.getPageSource().contains("Delhi Daredevils") && driver.getPageSource().contains("Royal Challengers Bangalore") && driver.getPageSource().contains("CSK"))
		{
			System.out.println("All teams are present");
		}
		else
			System.out.println("One of the team is missing");
